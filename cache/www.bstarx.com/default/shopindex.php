...
<head>
    ...
    <link rel="stylesheet" href="http://dev1.bstarx.com/baijiacms/themes/default/__RESOURCE__/css/bootstrap.min.css" type="text/css"/>
    <link rel="stylesheet" href="http://dev1.bstarx.com/baijiacms/themes/default/__RESOURCE__/css/base.css" type="text/css"/>
    <link rel="stylesheet" href="http://dev1.bstarx.com/baijiacms/themes/default/__RESOURCE__/css/iconfont.css"/>
    <script type="text/javascript" src="http://dev1.bstarx.com/baijiacms/themes/default/__RESOURCE__/js/jquery-1.11.3.min.js"></script>
</head>
<body>
...
<div class="indexsearch">
    ...
    <div class="row">
        <div class="slider card card-nomb" style="visibility: visible;">
            <script type="text/javascript" src="http://dev1.bstarx.com/baijiacms/themes/default/__RESOURCE__/js/TouchSlide.1.1.js"></script>
    ...
    <div class="row ptb10">
        <div class="col-xsl-2">
            <a href="<?php echo mobile_url('goodlist')?>">
                <img class="img-responsive" src="http://dev1.bstarx.com/baijiacms/themes/default/__RESOURCE__/images/t1.jpg" style="display: inline;">
                <span>全部商品</span>
            </a>
        </div>
    <div class="col-xsl-2">
            <a href="<?php echo mobile_url('myorder',array('status'=>99))?>">
                <img class="img-responsive" src="http://dev1.bstarx.com/baijiacms/themes/default/__RESOURCE__/images/t6.png" style="display: inline;">
                <span>我的订单</span>
            </a>
        </div>
        ...
        <div class="col-xsl-2">
            <a href="<?php echo mobile_url('bonus')?>">
                <img class="img-responsive" src="http://dev1.bstarx.com/baijiacms/themes/default/__RESOURCE__/images/t5.png" style="display: inline;">
                <span>优惠券</span>
            </a>
        </div>
        ...
        <div class="col-xsl-2">
            <a href="<?php echo mobile_url('help')?>">
                <img class="img-responsive" src="http://dev1.bstarx.com/baijiacms/themes/default/__RESOURCE__/images/t2.png" style="display: inline;">
                <span>购物须知</span>
            </a>
        </div>
