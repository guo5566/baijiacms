...
<script type="text/javascript" src="http://dev1.bstarx.com/baijiacms/themes/default/__RESOURCE__/script/angular.min.js"></script>
	<link type="text/css" rel="stylesheet" href="http://dev1.bstarx.com/baijiacms/themes/default/__RESOURCE__/style/font-awesome.min.css" />
	...
	<script type="text/javascript" src="http://dev1.bstarx.com/baijiacms/themes/default/__RESOURCE__/mobile/default/script/jquery.touchwipe.js"></script>
	<script type="text/javascript" src="http://dev1.bstarx.com/baijiacms/themes/default/__RESOURCE__/mobile/default/script/swipe.js"></script>
<style type='text/css'>
...
<div class="my_nav">
        <ul id="nav">
			...
			<li <?php if($status==-5) { ?>class='cur'<?php } else { ?>class=""<?php } ?>><a href="<?php echo mobile_url('myorder',array('status'=>-5))?>">退换货</a></li>
        </ul>
    </div>
