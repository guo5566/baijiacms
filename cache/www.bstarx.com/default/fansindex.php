...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://dev1.bstarx.com/baijiacms/themes/default/__RESOURCE__/recouse/css/fcommom.css?version=20150713">
    <link rel="stylesheet" type="text/css" href="http://dev1.bstarx.com/baijiacms/themes/default/__RESOURCE__/recouse/css/fd.css">
...
<div class="panel memberhead">
    <div class="header-l"><?php if(empty($avatar)){?><img class="icon-level-p1"
                                                                src="http://dev1.bstarx.com/baijiacms/themes/default/__RESOURCE__/recouse/images/tx.png"/><?php }else{ ?><img
...
<div class="panel member-nav">
    ...
    <ul class="side-nav">
        ...
        <?php if($is_login){?>
            <?php if(!empty($weixinfans)&&$_CMS['addons_bj_qrcode']&&$hasqrcode){?>
 <li><a href="<?php echo create_url('mobile',array('name' => 'bj_qrcode','do' => 'qrcode'));?>">&nbsp;&nbsp;<i class="icon-edit icon_i"></i>&nbsp;<span class="text">专属二维码</span><i class="arrow"></i></a></li>
     <?php } ?>
