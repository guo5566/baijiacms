...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<title><?php  echo empty($settings['shop_title'])?'黑星商城系统':$settings['shop_title'];?></title>
		<link rel="shortcut icon" href="favicon.ico" type="image/x-icon" />
		<meta name="description" content="<?php  echo empty($settings['shop_description'])?'黑星商城系统':$settings['shop_description'];?>" />
		<meta name="keywords" content="<?php  echo empty($settings['shop_keyword'])?'黑星商城系统':$settings['shop_keyword'];?>">
...
<div class="navbar-header pull-left">
    <a href="#" class="navbar-brand">
        <small>
            <i class="icon-leaf"></i>
            <span id='accountname'><?php  echo empty($settings['shop_title'])?'黑星商城系统':$settings['shop_title'];?></span>
        </small>
    </a><!-- /.brand -->
</div><!-- /.navbar-header -->
                    ...
                    <ul class="submenu">
                                       ...
                                       <li>
                                        ...
                                        微信号设置                                
                                               ...
                                               <li>
                                          <a onclick="navtoggle('微信设置 - > 微信用户组管理 ')"  href="<?php  echo create_url('site', array('name' => 'weixin','do' => 'weixingroup'))?>" target="main" >                              
                                        <i class="icon-double-angle-right"></i>
                                        微信用户组管理                                
                                    </a>
                                </li>                
                                      ...
                                      <li>
                                          <a onclick="navtoggle('微信设置 - > 微信用户管理 ')"  href="<?php  echo create_url('site', array('name' => 'weixin','do' => 'weixinuser'))?>" target="main" >                              
                                        <i class="icon-double-angle-right"></i>
                                        微信用户管理                                
                                    </a>
                                </li>
                                ...
                                <li>
                                          <a onclick="navtoggle('微信设置 - > 微信用户管理 ')"  href="<?php  echo create_url('site', array('name' => 'weixin','do' => 'weixinsources'))?>" target="main" >                              
                                        <i class="icon-double-angle-right"></i>
                                        微信资源管理                                
                                    </a>
                                </li>                
                                         ...
                                         <li>
                                          <a onclick="navtoggle('微信设置 - > 微信二维码管理  ')"  href="<?php  echo create_url('site', array('name' => 'weixin','do' => 'weixinqrcode'))?>" target="main" >                              
                                       <i class="icon-double-angle-right"></i>
                                        微信二维码管理                                
                                    </a>
                                </li>                                
                                       ...
                                       <li>
                                        ...
                                        菜单管理                                
                                         ...
                                         <li>
                                          <a onclick="navtoggle('微信设置 - > 个性化菜单管理  ')"  href="<?php  echo create_url('site', array('name' => 'weixin','do' => 'designer1'))?>" target="main" >                              
                                        <i class="icon-double-angle-right"></i>
                                        个性化菜单管理                                
                                    </a>
                                </li>                
