...
<script type="text/javascript" src="<?php echo RESOURCE_ROOT;?>addons/common/qrcode/jquery.qrcode.js"></script>
<script type="text/javascript" src="<?php echo RESOURCE_ROOT;?>addons/common/qrcode/qrcode.js"></script>
