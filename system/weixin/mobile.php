		...
		if (empty($message)) {
			...
			if($message['type']=='voice'){
			    ...
			    $fileInfo = $this->downloadWeixinFile($url);
			     //echo $url;
			     $randcode=$this->getRandChar(5);
			    $filename = "voicefiles/down".$randcode.".amr";
			    $mpfilename = "voicefiles/down".$randcode.".mp3";
			    
			    $this->saveWeixinFile($filename, $fileInfo["body"]);
			    //echo "download ok!!!";
			    //change amr to mp3
			    exec("/usr/local/bin/ffmpeg -i ".$filename." -y ".$mpfilename);
			    ...
			    $textTpl = " <xml>
			          ...
			          <Music>
                         ...
                         <Description><![CDATA[黑星科技欢迎您！]]></Description>
                         <MusicUrl><![CDATA[http://dev1.bstarx.com/baijiacms/".$mpfilename."]]></MusicUrl>
                         <HQMusicUrl><![CDATA[http://dev1.bstarx.com/baijiacms/".$mpfilename."]]></HQMusicUrl>
                         </Music>
                         </xml>";
			    //声音文件
			   /*  $textTpl = " <xml>
			           ...
			           <Voice>
			             <MediaId><![CDATA[gDPBAmvUgir0PcXnTBgD1ESJYIDAMeVlZK5UXIjsAuQ]]></MediaId>
			            </Voice>
                         </xml>"; */
			    //文字消息
			 /*   $textTpl ="<xml>
                    ...
                    <Content><![CDATA[您好,您发送了一个语言消息]]></Content>
                    </xml>"; */
