...
<script type="text/javascript" src="<?php echo RESOURCE_ROOT;?>/addons/common/jscity/jquery.cityselect.js"></script>
...
function addMenu(){if(!($(".mlist .hover").length>=3)){var t='<tr class="hover" data-url=""><td><div class="menu"><input type="text" class="span4" value=""> &nbsp; &nbsp; <a href="javascript:;" onclick="setMenuAction($(this).parent().parent().parent());" class="icon-edit" title="功能设置">功能设置</a> &nbsp; <a href="javascript:;" onclick="deleteMenu(this)" class="icon-remove-sign" title="删除">删除</a> &nbsp; <a href="javascript:;" onclick="addSubMenu($(this).parent().next());" title="添加子菜单" class="icon-plus-sign" title="添加菜单">添加子菜单</a> </div><div class="smlist submenu"></div></td></tr>';$("tbody.mlist").append(t)}}
function addSubMenu(t){if(!(t.find("div").length>=5)){var a='<div style="margin-top:20px;padding-left:80px;" data-url=""><input type="text" class="span3" value=""> &nbsp; &nbsp; <a href="javascript:;" onclick="setMenuAction($(this).parent());" class="icon-edit" title="功能设置">功能设置</a> &nbsp; <a href="javascript:;" onclick="deleteMenu(this)" class="icon-remove-sign" title="删除">删除</a> </div>';t.append(a)}}
function deleteMenu(t){$(t).parent().parent().hasClass("smlist")?$(t).parent().remove():$(t).parent().parent().parent().remove()}
...
function saveMenuAction(t){var a=currentEntity,e=$(":radio:checked").val();if("forward"==e?e="click":"url"==e&&(e="view"),null!=a){if("view"==e)if(/^(http|https|tel)(.*)/.test($("#ipt-url").val()))$(a).data("url",$("#ipt-url").val());else{if("save"==t)return alert("由于公众平台限制，URL必须以http或是https开头。"),!1;$(a).data("url","http://")}$(a).data("do",e),$(a).data("forward",$("#ipt-forward").val())}}
function saveMenu(t){if($("#menutype").val(t),"history"==t&&$("#form")[0].submit(),$(".span4:text").length>3)return void alert("不能输入超过 3 个主菜单才能保存.");if($(".span4:text,.span3:text").filter(function(){return""==$.trim($(this).val())}).length>0)return void alert("存在未输入名称的菜单.");var a="[",e=!1;return $(".mlist .hover").each(function(){var t=$.trim($(this).find(".span4:text").val()).replace(/"/g,'"');if("forward"==$(this).data("do"))var i="click";else if("url"==$(this).data("do"))var i="view";else var i=$(this).data("do");var r=$(this).data("url");r||(r="");var n=$.trim($(this).data("forward"));if(n||(n=""),a+='{"name": "'+t+'"',$(this).find(".smlist div").length>0){if(a+=',"sub_button": [',$(this).find(".smlist div").each(function(){var t=$.trim($(this).find(".span3:text").val()).replace(/"/g,'"');if("forward"==$(this).data("do"))var i="click";else if("url"==$(this).data("do"))var i="view";else var i=$(this).data("do");var r=$(this).data("url");r||(r="");var n=$.trim($(this).data("forward"));return n||(n=""),a+='{"name": "'+t+'"',"view"!=i&&""==n||"view"==i&&!r?(alert("子菜单项 “"+t+"”未设置对应规则."),e=!0,!1):(a+="click"==i?',"type": "click","key": "'+encodeURIComponent(n)+'"':"view"==i?',"type": "view","url": "'+r+'"':',"type": "'+i+'","key": "'+encodeURIComponent(n)+'"',void(a+="},"))}),e)return!1;a=a.slice(0,-1),a+="]"}else{if("view"!=i&&""==n||"view"==i&&!r)return alert("菜单 “"+t+"”不存在子菜单项, 且未设置对应规则."),e=!0,!1;a+="click"==i?',"type": "click","key": "'+encodeURIComponent(n)+'"':"view"==i?',"type": "view","url": "'+r+'"':',"type": "'+i+'","key": "'+encodeURIComponent(n)+'"'}a+="},"}),e?!1:(a=a.slice(0,-1),a+="]",$("#menudate").val(a),$("#do").val("menumodify"),void $("#form")[0].submit())}
function actionurl(t){$("#ipt-url").val(t)}
var pIndex=1,currentEntity=null;
  $(function(){$(".mlist .hover").each(function(){$(this).data("do",$(this).attr("data-do")),$(this).data("url",$(this).attr("data-url")),$(this).data("forward",$(this).attr("data-forward"))}),$(".mlist .hover .smlist div").each(function(){$(this).data("do",$(this).attr("data-do")),$(this).data("url",$(this).attr("data-url")),$(this).data("forward",$(this).attr("data-forward"))}),$(':radio[name="ipt"]').click(function(){this.checked&&("url"==$(this).val()?($("#url-container").show(),$("#forward-container").hide()):($("#url-container").hide(),$("#forward-container").show()))}),$("#dialog").modal({backdrop:"static",keyboard:!1,show:!1}),$("#ipt-forward").keydown(function(t){13==t.keyCode&&$("#search").click()}),$("#dialog").click(function(t){var a=$(t.target).attr("id")})}); 


  function saveMenu1(t){
		var matchrule='{"country":"'+$("#country").val()+'","province":"'+$("#prov1").val()+'","city":"'+$("#city1").val()+'","language":"'+$("#menulang").val()+'"}';
		$("#matchrule").val(matchrule);
	  if($("#menutype").val(t),"history"==t&&$("#form")[0].submit(),$(".span4:text").length>3)return void alert("不能输入超过 3 个主菜单才能保存.");if($(".span4:text,.span3:text").filter(function(){return""==$.trim($(this).val())}).length>0)return void alert("存在未输入名称的菜单.");var a="[",e=!1;return $(".mlist .hover").each(function(){var t=$.trim($(this).find(".span4:text").val()).replace(/"/g,'"');if("forward"==$(this).data("do"))var i="click";else if("url"==$(this).data("do"))var i="view";else var i=$(this).data("do");var r=$(this).data("url");r||(r="");var n=$.trim($(this).data("forward"));if(n||(n=""),a+='{"name": "'+t+'"',$(this).find(".smlist div").length>0){if(a+=',"sub_button": [',$(this).find(".smlist div").each(function(){var t=$.trim($(this).find(".span3:text").val()).replace(/"/g,'"');if("forward"==$(this).data("do"))var i="click";else if("url"==$(this).data("do"))var i="view";else var i=$(this).data("do");var r=$(this).data("url");r||(r="");var n=$.trim($(this).data("forward"));return n||(n=""),a+='{"name": "'+t+'"',"view"!=i&&""==n||"view"==i&&!r?(alert("子菜单项 “"+t+"”未设置对应规则."),e=!0,!1):(a+="click"==i?',"type": "click","key": "'+encodeURIComponent(n)+'"':"view"==i?',"type": "view","url": "'+r+'"':',"type": "'+i+'","key": "'+encodeURIComponent(n)+'"',void(a+="},"))}),e)return!1;a=a.slice(0,-1),a+="]"}else{if("view"!=i&&""==n||"view"==i&&!r)return alert("菜单 “"+t+"”不存在子菜单项, 且未设置对应规则."),e=!0,!1;a+="click"==i?',"type": "click","key": "'+encodeURIComponent(n)+'"':"view"==i?',"type": "view","url": "'+r+'"':',"type": "'+i+'","key": "'+encodeURIComponent(n)+'"'}a+="},"}),e?!1:(a=a.slice(0,-1),a+="]",$("#menudate").val(a),$("#do").val("menumodify1"),void $("#form")[0].submit())}
  
$(function(){
	$("#city_4").citySelect({
		url:"<?php echo RESOURCE_ROOT;?>/addons/common/jscity/city.min.js",
		prov:"北京",
		city:"海淀区",
		nodata:"none"
	}); 
...
<h3 class="header smaller lighter blue">个性化菜单设计器</h3>

<div class="main">
	<div class="form form-horizontal">
		
		
		<br/><h4 class="modal-title">个性化菜单：</h4><br/>
		
		<table class="table">
			<tbody class="mlist ui-sortable">
			<input type="hidden" id="menu-index" value="" data-subindex="" />
 			<?php  if(!empty($menus['conditionalmenu'])) { ?>
			<?php  if(is_array($menus['conditionalmenu'])) { foreach($menus['conditionalmenu'] as $conmenus) {
			    
			    foreach($conmenus['button'] as $row) {
			...
			<tr class="hover" data-do="<?php  echo $row['type'];?>" data-url="<?php  echo $row['url'];?>" data-forward="<?php  echo $row['forward'];?>">
				...
				<tr><td>
				<div>国家：<?php echo $conmenus['matchrule']['country'];  ?> &nbsp; &nbsp;&nbsp; &nbsp;省：<?php echo $conmenus['matchrule']['province'];  ?> &nbsp; &nbsp;&nbsp; &nbsp; 市：<?php echo $conmenus['matchrule']['city'];  ?>  &nbsp; &nbsp;&nbsp; &nbsp; 语言：<?php if($conmenus['matchrule']['language']=='zh_CN'){
				  echo "中文";  
				}else{
				    echo "英文";
				}   ?>  </div>	
				...
				<a class="btn btn-xs btn-info"  href="<?php  echo web_url('designer1', array('op'=>'deleteconmenu','menuid' => $conmenus['menuid']))?>"><i class="icon-edit"></i>删除此个性菜单</a>
				<td></tr>
		...
		<table class="table">
			<tbody>
			    <tr>
			     <td>   <br/><h4 class="modal-title">选择语言区域：</h4><br/>
			     <h4 class="modal-title">语言:</h4>
			      <select name="menulang" id="menulang">
      ...
      <div id="city_4">
			<select id="prov1" name="prov1" class="prov"></select> 	
			<select id="city1" name="city1"  class="city" disabled="disabled"></select>
			<select id="dist1" name="dist1"  class="dist" disabled="disabled"></select>
		</div></td>
			    </tr>
				<tr>
					<td>
						<input type="button" value="+添加菜单" class="btn btn-warning span3" onclick="addMenu();"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="保存个性化菜单结构" class="btn btn-primary span3" onclick="return saveMenu1();"/>&nbsp;&nbsp;&nbsp;&nbsp;
...
<form action="" method="post" id="form">
	...
	<input id="matchrule" name="matchrule" type="hidden" /> 
</form>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:150px">
		...
		<tr id="url-container">
				...
				<tr>
										<td>	
					<a href="javascript:;" onclick="actionurl('<?php echo WEBSITE_ROOT."index.php";?>');"><i class="icon-home"></i>商城首页</a>&nbsp;
